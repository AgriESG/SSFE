  ...
  return SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        const Text(
          'Tell us what matters most — we\'ll optimise your food choices around it.',
          style: TextStyle(
            fontSize: 15,
            color: AppColors.textSecondary,
            height: 1.5,
        ...
        _buildSelectorSection(
          ...
          ['Save Money', 'Balanced Spend', 'Premium Quality'],
        ),
        const SizedBox(height: 20),
        _buildSelectorSection(
          '🌍',
          ...
          ['Not Important', 'Balanced', 'Highly Important'],
        ),
        const SizedBox(height: 20),
        ...
        ...NutritionGoal.values.map((goal) {
          ...
          final labels = {
            NutritionGoal.balanced: 'Balanced',
